...
export class UnderageError extends DomainError {
  constructor() {
    super(400, "UNDERAGE", "You must be at least 18 years old to register.");
  }
}

export class TermsConsentRequiredError extends DomainError {
  constructor() {
    super(400, "TERMS_CONSENT_REQUIRED", "You must agree to the Terms of Service and Privacy Policy.");
  }
}

export class EmailNotVerifiedError extends DomainError {
  constructor() {
    super(403, "EMAIL_NOT_VERIFIED", "Please verify your email address first.");
  }
}

export class GeoBlockedError extends DomainError {
  constructor(state: string) {
    super(403, "GEO_BLOCKED", `A Stack'd is not available in your state (${state}).`);
  }
}
