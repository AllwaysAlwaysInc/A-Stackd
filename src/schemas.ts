...
export const PoolSchema = Type.Object({
  ...
  serverSeed: Type.Optional(Type.String()),
  serverSeedHash: Type.Optional(Type.String()),
  clientSeed: Type.Optional(Type.String()),
  finalSeed: Type.Optional(Type.String()),
  winnerIndex: Type.Optional(Type.Integer()),
});
